...
//     <h2 className="section-title">Find Dermatologists Near You</h2>
//     <div className="diet-grid">
//       {/* Clinic 1 */}
//       <div className="diet-card location-card">
//         <div className="clinic-header">
//           <div className="clinic-icon">🏥</div>
//           <h3>SkinCare Specialists</h3>
...
//             📞 Call Now
//           </button>
//           <button className="action-button map">
//             🗺️ Directions
//           </button>
//         </div>
//       </div>
...
//         <div className="clinic-details">
//           <p className="address">
//             456 Clear Skin Boulevard<br />
//             Floor 3<br />
//             New York, NY 10016
//           </p>
//           <p className="distance">
//             📍 2.5 miles from your location
//           </p>
//           <p className="hours">
...
//             <img src="/doctor-avatar.jpg" alt="Dr. Lee" />
//           </div>
...
//   { id: 1, title: "SkinCare Specialists", latitude: 40.748817, longitude: -73.985428 },
//   { id: 2, title: "DermaNatural Clinic", latitude: 40.742054, longitude: -73.987984 },
//   { id: 3, title: "Advanced Dermatology Center", latitude: 40.751908, longitude: -73.977183 },
// ];
...
//             Dermatologists have <br />effective tools and expertise
            
//             to help you manage your acne<br /> and achieve lasting results.
//           </p>
//         </div>

//         <div className="image-wrapper">
//           <img src="/images/D 7.png" alt="AI Face" className="main-image" />
//           <div className="image-shadow"></div>
//         </div>
...
//           </div>
//           <div className="animatedcharacter image-D">
//             <img src="/images/D 8.png" alt="Acne AI Guide" className="character-image" />
//           </div>
//         </div>
//       </div>

//       {/* 🔁 Replaced lower section with interactive map */}
//       <div className="map-section-container">
//         <h2 className="section-title">Dermatologist Clinics Near You</h2>
//         <MapContainer center={[40.748817, -73.985428]} zoom={13} className="map-section">
//           <TileLayer
    ...
    <div>
      <div className="hero-container">
        ...
        <div className="hero-content ">
          ...
          <h1>Expert Help is Just a Click Away!</h1>
          <p>
            Severe skin can be challenging, but it's not hopeless.
            Dermatologists have effective tools and expertise
            to help you manage your skin and achieve lasting results.
          </p>
        </div>
      ...
      <div className="analysiscontainer">
        <div className="backgroundoverlay">
          ...
          <div className="animatedcharacter image-D">
            <img src="/images/D 8.png" alt="Skin AI Guide" className="character-image" />
          </div>
        </div>
      </div>
        ...
        {selectedLocation && (
          <div className="location-details-container">
            <div className="location-details-content">
              ...
              <p><strong>Doctor:</strong> {selectedLocation.doctor}</p>
              <p><strong>Specialty:</strong> {selectedLocation.specialty}</p>
              <p><strong>Rating:</strong> {selectedLocation.rating} ★</p>
              <p><strong>Address:</strong> {selectedLocation.address}</p>
              <p><strong>Facility Type:</strong> {selectedLocation.facilityType}</p>
